var hockey1;
		...
		var myGameArea = {
			...
			stop: function() {
				if (point1 == 12 || point2 == 12){
					...
					document.getElementById("score").innerHTML = point1;
					...
					if (point1 == 12){
						...
						var textnode = document.createTextNode("비밀번호 : yeongdeungpo");         
		...
		function updateGameArea() {
			...
			if (myGameArea.keys && myGameArea.keys[81]) { //q키
				hockey1.y -= 10;
			...
			if (myGameArea.keys && myGameArea.keys[65]) { //a키
				hockey1.y += 10;
				if (ball.crashWith(hockey1)) {
					ball.speedY = 4;
					ball.speedX = 14;
			...
			if (myGameArea.keys && myGameArea.keys[79]) { // o키
				hockey2.y -= 10;
			...
			if (myGameArea.keys && myGameArea.keys[76]) { // l키
				hockey2.y += 10;
				if (ball.crashWith(hockey2)) {
					ball.speedY = 4;
					ball.speedX = -8;
